...
CREATE TABLE `gatos` (
  ...
  `creado_en` timestamp(3) NULL DEFAULT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `creado_en_UNIQUE` (`creado_en`)
...
CREATE TABLE `tiene` (
  ...
  CONSTRAINT `tiene_ibfk_1` FOREIGN KEY (`username`) REFERENCES `usuarios` (`username`),
  CONSTRAINT `tiene_ibfk_2` FOREIGN KEY (`creado_en`) REFERENCES `gatos` (`creado_en`)
...
-- Dump completed on 2024-03-11 16:15:45
